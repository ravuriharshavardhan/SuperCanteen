  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <CustomCartProductCard  enableExchangeStyle={false} enableReorder={false} enableReturn={false} enableExchangeSize={false} label={'Exchange will be picked and delivered on 22nd May.'} />
      </View>
      ...
      <View style={styles.priceDetailsSection}>
        <OrderPriceDetails  enableCOD={false} />
      </View>
    </ScrollView>
  );
};

export default OrderExchangeScreen;
