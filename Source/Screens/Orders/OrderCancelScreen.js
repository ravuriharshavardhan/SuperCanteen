  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <CustomCartProductCard  enableExchangeStyle={false} enableReorder={false} enableReturn={false} enableExchangeSize={false} label={'Order is cancelled on your request.'} />
      </View>
